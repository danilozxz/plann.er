...
interface DestinationAndDateStepProps {
    ...
    setDestinacion: (destination: string) => void
    setEventStartAndEndDates: (dates: DateRange | undefined) => void
    eventStartAndEndDates: DateRange | undefined
}

export const DestinationAndDateStep = ({ isGuestsInputOpen, closeGuestsInput, openGuestsInput, setDestinacion, setEventStartAndEndDates, eventStartAndEndDates }: DestinationAndDateStepProps) => {
        ...
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            <div className='flex items-center gap-2 flex-1'>
                ...
                <input
                    ...
                    onChange={event => setDestinacion(event.target.value)}
                    />
            </div>
